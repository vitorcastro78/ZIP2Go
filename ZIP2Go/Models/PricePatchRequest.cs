...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PricePatchRequest : IEquatable<PricePatchRequest>
    { 
        /// <summary>
        ...
        public OneOfpricePatchRequestCustomObjects CustomObjects { get; private set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PricePatchRequest)obj);
        }

        /// <summary>
        /// Returns true if PricePatchRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of PricePatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricePatchRequest other)
        {
            ...
            return 
                ...
                (
                    ...
                    UnitAmounts != null &&
                    UnitAmounts.Equals(other.UnitAmounts)
                ) && 
                (
                    DiscountAmounts == other.DiscountAmounts ||
                    DiscountAmounts != null &&
                    DiscountAmounts.Equals(other.DiscountAmounts)
                ) && 
                (
        ...
        public static bool operator ==(PricePatchRequest left, PricePatchRequest right)
        {
