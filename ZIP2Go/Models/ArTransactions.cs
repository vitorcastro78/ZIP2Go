...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArTransactions : IEquatable<ArTransactions>
    { 
        /// <summary>
        /// Credit memo numbers.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ArTransactions)obj);
        }

        /// <summary>
        /// Returns true if ArTransactions instances are equal
        /// </summary>
        /// <param name="other">Instance of ArTransactions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArTransactions other)
        {
        ...
        public static bool operator ==(ArTransactions left, ArTransactions right)
        {
