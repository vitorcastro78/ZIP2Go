...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class WriteOffRequest : IEquatable<WriteOffRequest>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((WriteOffRequest)obj);
        }

        /// <summary>
        /// Returns true if WriteOffRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of WriteOffRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteOffRequest other)
        {
        ...
        public static bool operator ==(WriteOffRequest left, WriteOffRequest right)
        {
