...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaxIdentifier : IEquatable<TaxIdentifier>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TaxIdentifier)obj);
        }

        /// <summary>
        /// Returns true if TaxIdentifier instances are equal
        /// </summary>
        /// <param name="other">Instance of TaxIdentifier to be compared</param>
        /// <returns>Boolean</returns>
