...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentScheduleItemPatch : IEquatable<PaymentScheduleItemPatch>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PaymentScheduleItemPatch)obj);
        }

        /// <summary>
        /// Returns true if PaymentScheduleItemPatch instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentScheduleItemPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentScheduleItemPatch other)
        {
            ...
            return 
                ...
                (
                    Unlink == other.Unlink ||
                    Unlink != null &&
                    Unlink.SequenceEqual(other.Unlink)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Unlink != null)
                    hashCode = hashCode * 59 + Unlink.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(PaymentScheduleItemPatch left, PaymentScheduleItemPatch right)
        {
