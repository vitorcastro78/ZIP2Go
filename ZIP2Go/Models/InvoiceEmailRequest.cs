...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvoiceEmailRequest : IEquatable<InvoiceEmailRequest>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InvoiceEmailRequest)obj);
        }

        /// <summary>
        /// Returns true if InvoiceEmailRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoiceEmailRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceEmailRequest other)
        {
            ...
            return 
                ...
                (
                    UseEmailTemplate == other.UseEmailTemplate ||
                    UseEmailTemplate != null &&
                    UseEmailTemplate.Equals(other.UseEmailTemplate)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (UseEmailTemplate != null)
                    hashCode = hashCode * 59 + UseEmailTemplate.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(InvoiceEmailRequest left, InvoiceEmailRequest right)
        {
