...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BillingDocumentItem : IEquatable<BillingDocumentItem>
    { 
        /// <summary>
        ...
        public OneOfbillingDocumentItemCustomObjects CustomObjects { get; private set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BillingDocumentItem)obj);
        }

        /// <summary>
        /// Returns true if BillingDocumentItem instances are equal
        /// </summary>
        /// <param name="other">Instance of BillingDocumentItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingDocumentItem other)
        {
            ...
            return 
                ...
                (
                    ...
                    PriceDescription.Equals(other.PriceDescription)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + PriceDescription.GetHashCode();
                    if (Name != null)
        ...
        public static bool operator ==(BillingDocumentItem left, BillingDocumentItem right)
        {
