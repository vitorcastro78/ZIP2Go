...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepaidBalance : IEquatable<PrepaidBalance>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PrepaidBalance)obj);
        }

        /// <summary>
        /// Returns true if PrepaidBalance instances are equal
        /// </summary>
        /// <param name="other">Instance of PrepaidBalance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepaidBalance other)
        {
        ...
        public static bool operator ==(PrepaidBalance left, PrepaidBalance right)
        {
