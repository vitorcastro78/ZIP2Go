...
namespace ZIP2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class FinanceInformation : IEquatable<FinanceInformation>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FinanceInformation)obj);
        }

        /// <summary>
        /// Returns true if FinanceInformation instances are equal
        /// </summary>
        /// <param name="other">Instance of FinanceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FinanceInformation other)
        {
            ...
            return 
                ...
                (
                    AccountReceivableAccountingCode == other.AccountReceivableAccountingCode ||
                    AccountReceivableAccountingCode != null &&
                    AccountReceivableAccountingCode.Equals(other.AccountReceivableAccountingCode)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (AccountReceivableAccountingCode != null)
                    hashCode = hashCode * 59 + AccountReceivableAccountingCode.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(FinanceInformation left, FinanceInformation right)
        {
