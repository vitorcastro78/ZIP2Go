...
{ 
    ...
    { 
        ...
        { 
            ...
            exampleJson = "{\n  \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"target_date\" : \"2000-01-23\",\n  \"custom_fields\" : \"\",\n  \"charges_excluded\" : [ \"one_time\", \"one_time\" ],\n  \"state_transitions\" : {\n    \"complete_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"processing_start_time\" : \"2000-01-23T04:56:07.000+00:00\"\n  },\n  \"assume_renewal\" : \"all\",\n  \"billing_preview_run_number\" : \"billing_preview_run_number\",\n  \"batches\" : [ \"batches\", \"batches\" ],\n  \"number_of_accounts_succeeded\" : 0.8008281904610115,\n  \"file\" : {\n    \"url\" : \"url\"\n  },\n  \"custom_objects\" : \"\",\n  \"include_evergreen_subscriptions\" : true,\n  \"number_of_accounts\" : 6.027456183070403,\n  \"updated_by_id\" : \"updated_by_id\",\n  \"include_draft_items\" : true,\n  \"id\" : \"id\",\n  \"created_by_id\" : \"created_by_id\",\n  \"state\" : \"pending\"\n}";
            
                        var example = exampleJson != null
                        ? JsonConvert.DeserializeObject<BillRunPreview>(exampleJson)
                        : default(BillRunPreview);            //TODO: Change the data returned
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult GetBillRunPreview([FromRoute][Required]string billRunPreviewId, [FromQuery]List<string> fields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize, [FromHeader]string zuoraTrackId, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(BillRunPreview));
