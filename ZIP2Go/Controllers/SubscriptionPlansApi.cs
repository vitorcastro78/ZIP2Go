...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <remarks>Retrieves the subscription plan with the given ID.</remarks>
        ...
        [HttpGet]
        [Route("/v2/subscription_plans/{subscription_plan_id}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("GetSubscriptionPlan")]
        [SwaggerResponse(statusCode: 200, type: typeof(SubscriptionPlan), description: "Default Response")]
        ...
        /// </summary>
        /// <remarks>Returns a dictionary with a data property that contains an array of subscription plans, starting after cursor. Each entry in the array is a separate  object. If no more  are available, the resulting array will be empty. This request should never return an error.</remarks>
        ...
        /// <response code="504">Gateway Timeout</response>
        [HttpGet]
        [Route("/v2/subscription_plans")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("GetSubscriptionPlans")]
        [SwaggerResponse(statusCode: 200, type: typeof(SubscriptionPlanListResponse), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
