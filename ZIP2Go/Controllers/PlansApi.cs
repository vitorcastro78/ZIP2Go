...
{ 
    ...
    { 
        ...
        /// Create a plan
        /// </summary>
        /// <remarks>Creates a new plan for an existing product.</remarks>
        ...
        [SwaggerResponse(statusCode: 201, type: typeof(Plan), description: "Default Response")]
        ...
        public virtual IActionResult CreatePlan([FromBody]PlanCreateRequest body, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding, [FromQuery]List<string> fields, [FromQuery]List<string> pricesFields, [FromQuery]List<string> productFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize)
        { 
            //TODO: Uncomment the next line to return response 201 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(201, default(Plan));
            ...
            exampleJson = "{\n  \"end_date\" : \"2000-01-23\",\n  \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"product\" : \"\",\n  \"custom_fields\" : \"\",\n  \"description\" : \"description\",\n  \"active\" : true,\n  \"custom_objects\" : \"\",\n  \"product_id\" : \"product_id\",\n  \"name\" : \"name\",\n  \"updated_by_id\" : \"updated_by_id\",\n  \"id\" : \"id\",\n  \"created_by_id\" : \"created_by_id\",\n  \"active_currencies\" : [ \"active_currencies\", \"active_currencies\" ],\n  \"sku\" : \"sku\",\n  \"prices\" : \"\",\n  \"plan_number\" : \"plan_number\",\n  \"start_date\" : \"2000-01-23\"\n}";
            
                        var example = exampleJson != null
                        ? JsonConvert.DeserializeObject<Plan>(exampleJson)
                        : default(Plan);            //TODO: Change the data returned
        ...
        /// Delete a plan
        /// </summary>
        /// <remarks>Permanently deletes a plan. It cannot be undone.</remarks>
        ...
        /// <response code="504">Gateway Timeout</response>
        [HttpDelete]
        [Route("/v2/plans/{plan_id}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("DeletePlan")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult DeletePlan([FromRoute][Required]string planId, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
        ...
        /// Retrieve a plan
        /// </summary>
        /// <remarks>Retrieves the plan with the given ID.</remarks>
        /// <param name="planId">The plan number or plan Id.</param>
        /// <param name="fields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;start_date&#x60;, &#x60;end_date&#x60;, &#x60;name&#x60;, &#x60;active&#x60;, &#x60;description&#x60;, &#x60;plan_number&#x60;, &#x60;product_id&#x60;, &#x60;active_currencies&#x60;          &lt;/details&gt;</param>
        /// <param name="pricesFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;tiers&#x60;, &#x60;charge_model&#x60;, &#x60;charge_type&#x60;, &#x60;name&#x60;, &#x60;description&#x60;, &#x60;revenue_recognition_rule&#x60;, &#x60;stacked_discount&#x60;, &#x60;recognized_revenue_accounting_code&#x60;, &#x60;deferred_revenue_accounting_code&#x60;, &#x60;accounting_code&#x60;, &#x60;recurring&#x60;, &#x60;start_event&#x60;, &#x60;tax_code&#x60;, &#x60;tax_inclusive&#x60;, &#x60;taxable&#x60;, &#x60;unit_of_measure&#x60;, &#x60;quantity&#x60;, &#x60;min_quantity&#x60;, &#x60;max_quantity&#x60;, &#x60;price_base_interval&#x60;, &#x60;discount_level&#x60;, &#x60;overage&#x60;, &#x60;plan_id&#x60;, &#x60;tiers_mode&#x60;, &#x60;apply_discount_to&#x60;, &#x60;prepayment&#x60;, &#x60;drawdown&#x60;, &#x60;discount_amounts&#x60;, &#x60;unit_amounts&#x60;, &#x60;discount_percent&#x60;, &#x60;amounts&#x60;          &lt;/details&gt;</param>
        /// <param name="productFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;start_date&#x60;, &#x60;end_date&#x60;, &#x60;active&#x60;, &#x60;name&#x60;, &#x60;type&#x60;, &#x60;sku&#x60;, &#x60;description&#x60;          &lt;/details&gt;</param>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(Plan), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult GetPlan([FromRoute][Required]string planId, [FromQuery]List<string> fields, [FromQuery]List<string> pricesFields, [FromQuery]List<string> productFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize, [FromHeader]string zuoraTrackId, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Plan));
        ...
        /// List plans
        /// </summary>
        /// <remarks>Returns a dictionary with a data property that contains an array of plans, starting after the cursor, if used. Each entry in the array is a separate plan object. If no more plans are available, the resulting array will be empty. This request should never return an error.</remarks>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(PlanListResponse), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult GetPlans([FromQuery]string cursor, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery]List<string> sort, [FromQuery][Range(1, 99)]int? pageSize, [FromQuery]List<string> fields, [FromQuery]List<string> pricesFields, [FromQuery]List<string> productFields, [FromHeader]string zuoraTrackId, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(PlanListResponse));
            ...
            exampleJson = "{\n  \"next_page\" : \"next_page\",\n  \"data\" : [ {\n    \"end_date\" : \"2000-01-23\",\n    \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"product\" : \"\",\n    \"custom_fields\" : \"\",\n    \"description\" : \"description\",\n    \"active\" : true,\n    \"custom_objects\" : \"\",\n    \"product_id\" : \"product_id\",\n    \"name\" : \"name\",\n    \"updated_by_id\" : \"updated_by_id\",\n    \"id\" : \"id\",\n    \"created_by_id\" : \"created_by_id\",\n    \"active_currencies\" : [ \"active_currencies\", \"active_currencies\" ],\n    \"sku\" : \"sku\",\n    \"prices\" : \"\",\n    \"plan_number\" : \"plan_number\",\n    \"start_date\" : \"2000-01-23\"\n  }, {\n    \"end_date\" : \"2000-01-23\",\n    \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"product\" : \"\",\n    \"custom_fields\" : \"\",\n    \"description\" : \"description\",\n    \"active\" : true,\n    \"custom_objects\" : \"\",\n    \"product_id\" : \"product_id\",\n    \"name\" : \"name\",\n    \"updated_by_id\" : \"updated_by_id\",\n    \"id\" : \"id\",\n    \"created_by_id\" : \"created_by_id\",\n    \"active_currencies\" : [ \"active_currencies\", \"active_currencies\" ],\n    \"sku\" : \"sku\",\n    \"prices\" : \"\",\n    \"plan_number\" : \"plan_number\",\n    \"start_date\" : \"2000-01-23\"\n  } ]\n}";
                        ...
                        var example = exampleJson != null
                        ? JsonConvert.DeserializeObject<PlanListResponse>(exampleJson)
                        : default(PlanListResponse);            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// Update a plan
        /// </summary>
        /// <remarks>Updates the specified plan by setting the values of the parameters passed. Any parameters not provided will be left unchanged.</remarks>
        /// <param name="body"></param>
        /// <param name="planId">The plan number or plan Id.</param>
        /// <param name="zuoraTrackId">A custom identifier for tracking API requests. If you set a value for this header, Zuora returns the same value in the response header. This header enables you to track your API calls to assist with troubleshooting in the event of an issue. The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (:), semicolon (;), double quote (\&quot;), or quote (&#x27;).</param>
        /// <param name="_async">Making asynchronous requests allows you to scale your applications more efficiently by leveraging Zuora&#x27;s infrastructure to enqueue and execute requests for you without blocking. These requests also use built-in retry semantics, which makes them much less likely to fail for non-deterministic reasons, even in extreme high-throughput scenarios. Meanwhile, when you send a request to one of these endpoints, you can expect to receive a response in less than 150 milliseconds and these calls are unlikely to trigger rate limit errors. If set to true, Zuora returns a 202 Accepted response, and the response body contains only a request ID.</param>
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult UpdatePlan([FromBody]PlanPatchRequest body, [FromRoute][Required]string planId, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding, [FromQuery]List<string> fields, [FromQuery]List<string> pricesFields, [FromQuery]List<string> productFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Plan));
