...
{ 
    ...
    { 
        ...
        /// Apply a credit memo
        /// </summary>
        /// <remarks>Apply a credit memo to one or more other billing documents.</remarks>
        ...
        [HttpPost]
        [Route("/v2/credit_memos/{credit_memo_id}/apply")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("ApplyCreditMemo")]
        ...
        /// </summary>
        /// <remarks>Cancels a credit memo. Only credit memos with the Draft status can be cancelled.</remarks>
        /// <param name="creditMemoId">Identifier for the credit memo, either &#x60;credit_memo_number&#x60; or &#x60;credit_memo_id&#x60;</param>
        /// <param name="fields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;credit_memo_number&#x60;, &#x60;state_transitions&#x60;, &#x60;description&#x60;, &#x60;account_id&#x60;, &#x60;total&#x60;, &#x60;subtotal&#x60;, &#x60;tax&#x60;, &#x60;document_date&#x60;, &#x60;exclude_from_auto_apply_rules&#x60;, &#x60;posted_by_id&#x60;, &#x60;state&#x60;, &#x60;balance&#x60;, &#x60;invoice_id&#x60;, &#x60;reason_code&#x60;, &#x60;amount_refunded&#x60;, &#x60;bill_to_id&#x60;, &#x60;billing_document_settings&#x60;, &#x60;currency&#x60;          &lt;/details&gt;</param>
        /// <param name="appliedToFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;id&#x60;, &#x60;amount&#x60;, &#x60;billing_document_id&#x60;, &#x60;billing_document_type&#x60;          &lt;/details&gt;</param>
        /// <param name="creditMemoItemsFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;amount&#x60;, &#x60;applied_to_item_id&#x60;, &#x60;price_id&#x60;, &#x60;discount_item&#x60;, &#x60;deferred_revenue_account&#x60;, &#x60;description&#x60;, &#x60;credit_memo_id&#x60;, &#x60;sku&#x60;, &#x60;name&#x60;, &#x60;purchase_order_number&#x60;, &#x60;quantity&#x60;, &#x60;recognized_revenue_account&#x60;, &#x60;remaining_balance&#x60;, &#x60;revenue_recognition_rule_name&#x60;, &#x60;service_end&#x60;, &#x60;service_start&#x60;, &#x60;accounts_receivable_account&#x60;, &#x60;on_account_account&#x60;, &#x60;subscription_id&#x60;, &#x60;subscription_item_id&#x60;, &#x60;tax&#x60;, &#x60;tax_code&#x60;, &#x60;tax_inclusive&#x60;, &#x60;unit_amount&#x60;, &#x60;unit_of_measure&#x60;, &#x60;subtotal&#x60;, &#x60;invoice_item_id&#x60;, &#x60;document_item_date&#x60;          &lt;/details&gt;</param>
        ...
        /// <response code="504">Gateway Timeout</response>
        [HttpPost]
        [Route("/v2/credit_memos/{credit_memo_id}/cancel")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("CancelCreditMemo")]
        [SwaggerResponse(statusCode: 200, type: typeof(CreditMemo), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        ...
        /// </summary>
        /// <remarks>Creates a new credit memo.</remarks>
        /// <param name="body"></param>
        /// <param name="zuoraTrackId">A custom identifier for tracking API requests. If you set a value for this header, Zuora returns the same value in the response header. This header enables you to track your API calls to assist with troubleshooting in the event of an issue. The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (:), semicolon (;), double quote (\&quot;), or quote (&#x27;).</param>
        /// <param name="_async">Making asynchronous requests allows you to scale your applications more efficiently by leveraging Zuora&#x27;s infrastructure to enqueue and execute requests for you without blocking. These requests also use built-in retry semantics, which makes them much less likely to fail for non-deterministic reasons, even in extreme high-throughput scenarios. Meanwhile, when you send a request to one of these endpoints, you can expect to receive a response in less than 150 milliseconds and these calls are unlikely to trigger rate limit errors. If set to true, Zuora returns a 202 Accepted response, and the response body contains only a request ID.</param>
        /// <param name="zuoraEntityIds">An entity ID. If you have Multi-entity enabled and the authorization token is valid for more than one entity, you must use this header to specify which entity to perform the operation on. If the authorization token is only valid for a single entity or you do not have Multi-entity enabled, you do not need to set this header.</param>
        ...
        [SwaggerResponse(statusCode: 201, type: typeof(CreditMemo), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult CreateCreditMemo([FromBody]CreditMemoCreateRequest body, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding, [FromQuery]List<string> fields, [FromQuery]List<string> appliedToFields, [FromQuery]List<string> creditMemoItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> accountFields, [FromQuery]List<string> billToFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize)
        { 
            //TODO: Uncomment the next line to return response 201 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(201, default(CreditMemo));
        ...
        /// </summary>
        /// <remarks>Permanently deletes a credit memo. This operation cannot be undone once it is performed.</remarks>
        /// <param name="creditMemoId">Identifier for the credit memo, either &#x60;credit_memo_number&#x60; or &#x60;credit_memo_id&#x60;</param>
        /// <param name="zuoraTrackId">A custom identifier for tracking API requests. If you set a value for this header, Zuora returns the same value in the response header. This header enables you to track your API calls to assist with troubleshooting in the event of an issue. The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (:), semicolon (;), double quote (\&quot;), or quote (&#x27;).</param>
        /// <param name="_async">Making asynchronous requests allows you to scale your applications more efficiently by leveraging Zuora&#x27;s infrastructure to enqueue and execute requests for you without blocking. These requests also use built-in retry semantics, which makes them much less likely to fail for non-deterministic reasons, even in extreme high-throughput scenarios. Meanwhile, when you send a request to one of these endpoints, you can expect to receive a response in less than 150 milliseconds and these calls are unlikely to trigger rate limit errors. If set to true, Zuora returns a 202 Accepted response, and the response body contains only a request ID.</param>
        /// <param name="zuoraEntityIds">An entity ID. If you have Multi-entity enabled and the authorization token is valid for more than one entity, you must use this header to specify which entity to perform the operation on. If the authorization token is only valid for a single entity or you do not have Multi-entity enabled, you do not need to set this header.</param>
        ...
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("DeleteCreditMemo")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult DeleteCreditMemo([FromRoute][Required]string creditMemoId, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
        ...
        /// </summary>
        /// <remarks>Retrieves the credit memo with the given ID.</remarks>
        /// <param name="creditMemoId">Identifier for the credit memo, either &#x60;credit_memo_number&#x60; or &#x60;credit_memo_id&#x60;</param>
        /// <param name="fields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;credit_memo_number&#x60;, &#x60;state_transitions&#x60;, &#x60;description&#x60;, &#x60;account_id&#x60;, &#x60;total&#x60;, &#x60;subtotal&#x60;, &#x60;tax&#x60;, &#x60;document_date&#x60;, &#x60;exclude_from_auto_apply_rules&#x60;, &#x60;posted_by_id&#x60;, &#x60;state&#x60;, &#x60;balance&#x60;, &#x60;invoice_id&#x60;, &#x60;reason_code&#x60;, &#x60;amount_refunded&#x60;, &#x60;bill_to_id&#x60;, &#x60;billing_document_settings&#x60;, &#x60;currency&#x60;          &lt;/details&gt;</param>
        /// <param name="appliedToFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;id&#x60;, &#x60;amount&#x60;, &#x60;billing_document_id&#x60;, &#x60;billing_document_type&#x60;          &lt;/details&gt;</param>
        /// <param name="creditMemoItemsFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;amount&#x60;, &#x60;applied_to_item_id&#x60;, &#x60;price_id&#x60;, &#x60;discount_item&#x60;, &#x60;deferred_revenue_account&#x60;, &#x60;description&#x60;, &#x60;credit_memo_id&#x60;, &#x60;sku&#x60;, &#x60;name&#x60;, &#x60;purchase_order_number&#x60;, &#x60;quantity&#x60;, &#x60;recognized_revenue_account&#x60;, &#x60;remaining_balance&#x60;, &#x60;revenue_recognition_rule_name&#x60;, &#x60;service_end&#x60;, &#x60;service_start&#x60;, &#x60;accounts_receivable_account&#x60;, &#x60;on_account_account&#x60;, &#x60;subscription_id&#x60;, &#x60;subscription_item_id&#x60;, &#x60;tax&#x60;, &#x60;tax_code&#x60;, &#x60;tax_inclusive&#x60;, &#x60;unit_amount&#x60;, &#x60;unit_of_measure&#x60;, &#x60;subtotal&#x60;, &#x60;invoice_item_id&#x60;, &#x60;document_item_date&#x60;          &lt;/details&gt;</param>
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult GetCreditMemo([FromRoute][Required]string creditMemoId, [FromQuery]List<string> fields, [FromQuery]List<string> appliedToFields, [FromQuery]List<string> creditMemoItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> accountFields, [FromQuery]List<string> billToFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize, [FromHeader]string zuoraTrackId, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(CreditMemo));
        ...
        /// </summary>
        /// <remarks>Retrieves information about all items of credit memos. A credit memo item is a single line item in a credit memo.</remarks>
        ...
        /// <response code="504">Gateway Timeout</response>
        [HttpGet]
        [Route("/v2/credit_memo_items")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("GetCreditMemoItems")]
        [SwaggerResponse(statusCode: 200, type: typeof(CreditMemoItemListResponse), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        { 
            ...
            exampleJson = "{\n  \"next_page\" : \"next_page\",\n  \"data\" : [ {\n    \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"accounts_receivable_account\" : \"accounts_receivable_account\",\n    \"service_end\" : \"service_end\",\n    \"subscription_item_id\" : \"subscription_item_id\",\n    \"revenue_recognition_rule_name\" : \"revenue_recognition_rule_name\",\n    \"price_id\" : \"price_id\",\n    \"description\" : \"description\",\n    \"subscription\" : \"\",\n    \"applied_to_item_id\" : \"applied_to_item_id\",\n    \"on_account_account\" : \"on_account_account\",\n    \"subscription_id\" : \"subscription_id\",\n    \"subscription_item\" : \"\",\n    \"deferred_revenue_account\" : \"deferred_revenue_account\",\n    \"unit_of_measure\" : \"unit_of_measure\",\n    \"purchase_order_number\" : \"purchase_order_number\",\n    \"id\" : \"id\",\n    \"sku\" : \"sku\",\n    \"service_start\" : \"service_start\",\n    \"discount_item\" : true,\n    \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"recognized_revenue_account\" : \"recognized_revenue_account\",\n    \"amount\" : 0.8008281904610115,\n    \"quantity\" : 1.4658129805029452,\n    \"remaining_balance\" : 5.962133916683182,\n    \"custom_fields\" : \"\",\n    \"invoice_item_id\" : \"invoice_item_id\",\n    \"credit_memo\" : \"\",\n    \"tax_inclusive\" : true,\n    \"tax\" : 2.3021358869347655,\n    \"unit_amount\" : 5.637376656633329,\n    \"accounting_code\" : \"accounting_code\",\n    \"tax_code\" : \"tax_code\",\n    \"document_item_date\" : \"2022-01-01T07:08:12-07:00\",\n    \"custom_objects\" : \"\",\n    \"credit_memo_id\" : \"credit_memo_id\",\n    \"subtotal\" : 6.027456183070403,\n    \"name\" : \"name\",\n    \"updated_by_id\" : \"updated_by_id\",\n    \"created_by_id\" : \"created_by_id\",\n    \"taxation_items\" : {\n      \"next_page\" : \"next_page\",\n      \"data\" : [ {\n        \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n        \"amount_paid\" : 4.145608029883936,\n        \"sales_tax_payable_account\" : \"sales_tax_payable_account\",\n        \"jurisdiction\" : \"jurisdiction\",\n        \"tax_rate\" : 7.061401241503109,\n        \"amount_refunded\" : 7.386281948385884,\n        \"on_account_account\" : \"on_account_account\",\n        \"location_code\" : \"location_code\",\n        \"id\" : \"id\",\n        \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n        \"amount_exempt\" : 9.301444243932576,\n        \"amount\" : 2.3021358869347655,\n        \"source_tax_item_id\" : \"source_tax_item_id\",\n        \"remaining_balance\" : 3.616076749251911,\n        \"custom_fields\" : \"\",\n        \"tax_inclusive\" : true,\n        \"tax_rate_type\" : \"percent\",\n        \"amount_applied\" : 1.2315135367772556,\n        \"tax_date\" : \"2022-01-01T00:00:00.000+00:00\",\n        \"tax_code\" : \"tax_code\",\n        \"custom_objects\" : \"\",\n        \"amount_credited\" : 2.027123023002322,\n        \"name\" : \"name\",\n        \"updated_by_id\" : \"updated_by_id\",\n        \"tax_code_name\" : \"tax_code_name\",\n        \"created_by_id\" : \"created_by_id\",\n        \"tax_rate_name\" : \"tax_rate_name\"\n      }, {\n        \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n        \"amount_paid\" : 4.145608029883936,\n        \"sales_tax_payable_account\" : \"sales_tax_payable_account\",\n        \"jurisdiction\" : \"jurisdiction\",\n        \"tax_rate\" : 7.061401241503109,\n        \"amount_refunded\" : 7.386281948385884,\n        \"on_account_account\" : \"on_account_account\",\n        \"location_code\" : \"location_code\",\n        \"id\" : \"id\",\n        \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n        \"amount_exempt\" : 9.301444243932576,\n        \"amount\" : 2.3021358869347655,\n        \"source_tax_item_id\" : \"source_tax_item_id\",\n        \"remaining_balance\" : 3.616076749251911,\n        \"custom_fields\" : \"\",\n        \"tax_inclusive\" : true,\n        \"tax_rate_type\" : \"percent\",\n        \"amount_applied\" : 1.2315135367772556,\n        \"tax_date\" : \"2022-01-01T00:00:00.000+00:00\",\n        \"tax_code\" : \"tax_code\",\n        \"custom_objects\" : \"\",\n        \"amount_credited\" : 2.027123023002322,\n        \"name\" : \"name\",\n        \"updated_by_id\" : \"updated_by_id\",\n        \"tax_code_name\" : \"tax_code_name\",\n        \"created_by_id\" : \"created_by_id\",\n        \"tax_rate_name\" : \"tax_rate_name\"\n      } ]\n    }\n  }, {\n    \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"accounts_receivable_account\" : \"accounts_receivable_account\",\n    \"service_end\" : \"service_end\",\n    \"subscription_item_id\" : \"subscription_item_id\",\n    \"revenue_recognition_rule_name\" : \"revenue_recognition_rule_name\",\n    \"price_id\" : \"price_id\",\n    \"description\" : \"description\",\n    \"subscription\" : \"\",\n    \"applied_to_item_id\" : \"applied_to_item_id\",\n    \"on_account_account\" : \"on_account_account\",\n    \"subscription_id\" : \"subscription_id\",\n    \"subscription_item\" : \"\",\n    \"deferred_revenue_account\" : \"deferred_revenue_account\",\n    \"unit_of_measure\" : \"unit_of_measure\",\n    \"purchase_order_number\" : \"purchase_order_number\",\n    \"id\" : \"id\",\n    \"sku\" : \"sku\",\n    \"service_start\" : \"service_start\",\n    \"discount_item\" : true,\n    \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"recognized_revenue_account\" : \"recognized_revenue_account\",\n    \"amount\" : 0.8008281904610115,\n    \"quantity\" : 1.4658129805029452,\n    \"remaining_balance\" : 5.962133916683182,\n    \"custom_fields\" : \"\",\n    \"invoice_item_id\" : \"invoice_item_id\",\n    \"credit_memo\" : \"\",\n    \"tax_inclusive\" : true,\n    \"tax\" : 2.3021358869347655,\n    \"unit_amount\" : 5.637376656633329,\n    \"accounting_code\" : \"accounting_code\",\n    \"tax_code\" : \"tax_code\",\n    \"document_item_date\" : \"2022-01-01T07:08:12-07:00\",\n    \"custom_objects\" : \"\",\n    \"credit_memo_id\" : \"credit_memo_id\",\n    \"subtotal\" : 6.027456183070403,\n    \"name\" : \"name\",\n    \"updated_by_id\" : \"updated_by_id\",\n    \"created_by_id\" : \"created_by_id\",\n    \"taxation_items\" : {\n      \"next_page\" : \"next_page\",\n      \"data\" : [ {\n        \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n        \"amount_paid\" : 4.145608029883936,\n        \"sales_tax_payable_account\" : \"sales_tax_payable_account\",\n        \"jurisdiction\" : \"jurisdiction\",\n        \"tax_rate\" : 7.061401241503109,\n        \"amount_refunded\" : 7.386281948385884,\n        \"on_account_account\" : \"on_account_account\",\n        \"location_code\" : \"location_code\",\n        \"id\" : \"id\",\n        \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n        \"amount_exempt\" : 9.301444243932576,\n        \"amount\" : 2.3021358869347655,\n        \"source_tax_item_id\" : \"source_tax_item_id\",\n        \"remaining_balance\" : 3.616076749251911,\n        \"custom_fields\" : \"\",\n        \"tax_inclusive\" : true,\n        \"tax_rate_type\" : \"percent\",\n        \"amount_applied\" : 1.2315135367772556,\n        \"tax_date\" : \"2022-01-01T00:00:00.000+00:00\",\n        \"tax_code\" : \"tax_code\",\n        \"custom_objects\" : \"\",\n        \"amount_credited\" : 2.027123023002322,\n        \"name\" : \"name\",\n        \"updated_by_id\" : \"updated_by_id\",\n        \"tax_code_name\" : \"tax_code_name\",\n        \"created_by_id\" : \"created_by_id\",\n        \"tax_rate_name\" : \"tax_rate_name\"\n      }, {\n        \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n        \"amount_paid\" : 4.145608029883936,\n        \"sales_tax_payable_account\" : \"sales_tax_payable_account\",\n        \"jurisdiction\" : \"jurisdiction\",\n        \"tax_rate\" : 7.061401241503109,\n        \"amount_refunded\" : 7.386281948385884,\n        \"on_account_account\" : \"on_account_account\",\n        \"location_code\" : \"location_code\",\n        \"id\" : \"id\",\n        \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n        \"amount_exempt\" : 9.301444243932576,\n        \"amount\" : 2.3021358869347655,\n        \"source_tax_item_id\" : \"source_tax_item_id\",\n        \"remaining_balance\" : 3.616076749251911,\n        \"custom_fields\" : \"\",\n        \"tax_inclusive\" : true,\n        \"tax_rate_type\" : \"percent\",\n        \"amount_applied\" : 1.2315135367772556,\n        \"tax_date\" : \"2022-01-01T00:00:00.000+00:00\",\n        \"tax_code\" : \"tax_code\",\n        \"custom_objects\" : \"\",\n        \"amount_credited\" : 2.027123023002322,\n        \"name\" : \"name\",\n        \"updated_by_id\" : \"updated_by_id\",\n        \"tax_code_name\" : \"tax_code_name\",\n        \"created_by_id\" : \"created_by_id\",\n        \"tax_rate_name\" : \"tax_rate_name\"\n      } ]\n    }\n  } ]\n}";
                        ...
                        var example = exampleJson != null
                        ? JsonConvert.DeserializeObject<CreditMemoItemListResponse>(exampleJson)
                        : default(CreditMemoItemListResponse);            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// List credit memos
        /// </summary>
        /// <remarks>Returns a dictionary with a data property that contains an array of credit memos, starting after cursor. Each entry in the array is a separate credit memo object. If no more credit memos are available, the resulting array will be empty. This request should never return an error.</remarks>
        /// <param name="cursor">A cursor for use in pagination. A cursor defines the starting place in a list. For instance, if you make a list request and receive 100 objects, ending with &#x60;next_page&#x3D;W3sib3JkZXJ&#x3D;&#x60;, your subsequent call can include &#x60;cursor&#x3D;W3sib3JkZXJ&#x3D;&#x60; in order to fetch the next page of the list.</param>
        /// <param name="expand">Allows you to expand responses by including related object information in a single call. See the [Expand responses](https://developer.zuora.com/quickstart-api/tutorial/expand-responses/) section of the Quickstart API Tutorials for detailed instructions.</param>
        /// <param name="filter">A case-sensitive filter on the list. See the [Filter lists](https://developer.zuora.com/quickstart-api/tutorial/filter-lists/) section of the Quickstart API Tutorials for detailed instructions.</param>
        /// <param name="sort">A case-sensitive query parameter that specifies the sort order of the list, which can be either ascending (e.g. &#x60;account_number.asc&#x60;) or descending (e.g. &#x60;account_number.desc&#x60;). You cannot sort on properties that are arrays. If the array-type properties are specified for the &#x60;sort[]&#x60; parameter, they are ignored.</param>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(CreditMemoListResponse), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult GetCreditMemos([FromQuery]string cursor, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery]List<string> sort, [FromQuery][Range(1, 99)]int? pageSize, [FromQuery]List<string> fields, [FromQuery]List<string> appliedToFields, [FromQuery]List<string> creditMemoItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> accountFields, [FromQuery]List<string> billToFields, [FromHeader]string zuoraTrackId, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(CreditMemoListResponse));
            ...
            exampleJson = "{\n  \"next_page\" : \"next_page\",\n  \"data\" : [ {\n    \"bill_to\" : \"\",\n    \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"account_number\" : \"RC-00020831\",\n    \"exclude_from_auto_apply_rules\" : true,\n    \"description\" : \"description\",\n    \"state_transitions\" : \"\",\n    \"amount_refunded\" : 0.8008281904610115,\n    \"reason_code\" : \"reason_code\",\n    \"total\" : 6.027456183070403,\n    \"credit_memo_number\" : \"credit_memo_number\",\n    \"balance\" : 5.637376656633329,\n    \"billing_document_settings\" : \"\",\n    \"invoice_id\" : \"invoice_id\",\n    \"currency\" : \"currency\",\n    \"id\" : \"id\",\n    \"state\" : \"draft\",\n    \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"transfer_to_accounting\" : true,\n    \"posted_by_id\" : \"posted_by_id\",\n    \"remaining_balance\" : 2.3021358869347655,\n    \"custom_fields\" : \"\",\n    \"bill_to_id\" : \"2c92c0f86a8dd422016a9e7a70116b0d\",\n    \"document_date\" : \"2023-01-01T00:00:00.000+00:00\",\n    \"applied_to\" : [ {\n      \"amount\" : 7.061401241503109,\n      \"billing_document\" : \"\",\n      \"billing_document_type\" : \"debit_memo\",\n      \"id\" : \"id\",\n      \"billing_document_id\" : \"billing_document_id\"\n    }, {\n      \"amount\" : 7.061401241503109,\n      \"billing_document\" : \"\",\n      \"billing_document_type\" : \"debit_memo\",\n      \"id\" : \"id\",\n      \"billing_document_id\" : \"billing_document_id\"\n    } ],\n    \"tax\" : 5.962133916683182,\n    \"account_id\" : \"account_id\",\n    \"custom_objects\" : \"\",\n    \"subtotal\" : 1.4658129805029452,\n    \"updated_by_id\" : \"updated_by_id\",\n    \"created_by_id\" : \"created_by_id\",\n    \"items\" : \"\",\n    \"account\" : \"\"\n  }, {\n    \"bill_to\" : \"\",\n    \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"account_number\" : \"RC-00020831\",\n    \"exclude_from_auto_apply_rules\" : true,\n    \"description\" : \"description\",\n    \"state_transitions\" : \"\",\n    \"amount_refunded\" : 0.8008281904610115,\n    \"reason_code\" : \"reason_code\",\n    \"total\" : 6.027456183070403,\n    \"credit_memo_number\" : \"credit_memo_number\",\n    \"balance\" : 5.637376656633329,\n    \"billing_document_settings\" : \"\",\n    \"invoice_id\" : \"invoice_id\",\n    \"currency\" : \"currency\",\n    \"id\" : \"id\",\n    \"state\" : \"draft\",\n    \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"transfer_to_accounting\" : true,\n    \"posted_by_id\" : \"posted_by_id\",\n    \"remaining_balance\" : 2.3021358869347655,\n    \"custom_fields\" : \"\",\n    \"bill_to_id\" : \"2c92c0f86a8dd422016a9e7a70116b0d\",\n    \"document_date\" : \"2023-01-01T00:00:00.000+00:00\",\n    \"applied_to\" : [ {\n      \"amount\" : 7.061401241503109,\n      \"billing_document\" : \"\",\n      \"billing_document_type\" : \"debit_memo\",\n      \"id\" : \"id\",\n      \"billing_document_id\" : \"billing_document_id\"\n    }, {\n      \"amount\" : 7.061401241503109,\n      \"billing_document\" : \"\",\n      \"billing_document_type\" : \"debit_memo\",\n      \"id\" : \"id\",\n      \"billing_document_id\" : \"billing_document_id\"\n    } ],\n    \"tax\" : 5.962133916683182,\n    \"account_id\" : \"account_id\",\n    \"custom_objects\" : \"\",\n    \"subtotal\" : 1.4658129805029452,\n    \"updated_by_id\" : \"updated_by_id\",\n    \"created_by_id\" : \"created_by_id\",\n    \"items\" : \"\",\n    \"account\" : \"\"\n  } ]\n}";
                        ...
                        var example = exampleJson != null
                        ? JsonConvert.DeserializeObject<CreditMemoListResponse>(exampleJson)
                        : default(CreditMemoListResponse);            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// </summary>
        /// <remarks>Updates a credit memo by setting the values of the specified fields. Any fields not provided in the request remain unchanged.</remarks>
        /// <param name="body"></param>
        /// <param name="creditMemoId">Identifier for the credit memo, either &#x60;credit_memo_number&#x60; or &#x60;credit_memo_id&#x60;</param>
        /// <param name="zuoraTrackId">A custom identifier for tracking API requests. If you set a value for this header, Zuora returns the same value in the response header. This header enables you to track your API calls to assist with troubleshooting in the event of an issue. The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (:), semicolon (;), double quote (\&quot;), or quote (&#x27;).</param>
        /// <param name="_async">Making asynchronous requests allows you to scale your applications more efficiently by leveraging Zuora&#x27;s infrastructure to enqueue and execute requests for you without blocking. These requests also use built-in retry semantics, which makes them much less likely to fail for non-deterministic reasons, even in extreme high-throughput scenarios. Meanwhile, when you send a request to one of these endpoints, you can expect to receive a response in less than 150 milliseconds and these calls are unlikely to trigger rate limit errors. If set to true, Zuora returns a 202 Accepted response, and the response body contains only a request ID.</param>
        ...
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("PatchCreditMemo")]
        [SwaggerResponse(statusCode: 200, type: typeof(CreditMemo), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult PatchCreditMemo([FromBody]CreditMemoPatchRequest body, [FromRoute][Required]string creditMemoId, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding, [FromQuery]List<string> fields, [FromQuery]List<string> appliedToFields, [FromQuery]List<string> creditMemoItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> accountFields, [FromQuery]List<string> billToFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(CreditMemo));
        ...
        /// Post a credit memo
        /// </summary>
        /// <remarks>Opens a draft credit memo.</remarks>
        /// <param name="creditMemoId">Identifier for the credit memo, either &#x60;credit_memo_number&#x60; or &#x60;credit_memo_id&#x60;</param>
        /// <param name="fields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;credit_memo_number&#x60;, &#x60;state_transitions&#x60;, &#x60;description&#x60;, &#x60;account_id&#x60;, &#x60;total&#x60;, &#x60;subtotal&#x60;, &#x60;tax&#x60;, &#x60;document_date&#x60;, &#x60;exclude_from_auto_apply_rules&#x60;, &#x60;posted_by_id&#x60;, &#x60;state&#x60;, &#x60;balance&#x60;, &#x60;invoice_id&#x60;, &#x60;reason_code&#x60;, &#x60;amount_refunded&#x60;, &#x60;bill_to_id&#x60;, &#x60;billing_document_settings&#x60;, &#x60;currency&#x60;          &lt;/details&gt;</param>
        /// <param name="appliedToFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;id&#x60;, &#x60;amount&#x60;, &#x60;billing_document_id&#x60;, &#x60;billing_document_type&#x60;          &lt;/details&gt;</param>
        /// <param name="creditMemoItemsFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;amount&#x60;, &#x60;applied_to_item_id&#x60;, &#x60;price_id&#x60;, &#x60;discount_item&#x60;, &#x60;deferred_revenue_account&#x60;, &#x60;description&#x60;, &#x60;credit_memo_id&#x60;, &#x60;sku&#x60;, &#x60;name&#x60;, &#x60;purchase_order_number&#x60;, &#x60;quantity&#x60;, &#x60;recognized_revenue_account&#x60;, &#x60;remaining_balance&#x60;, &#x60;revenue_recognition_rule_name&#x60;, &#x60;service_end&#x60;, &#x60;service_start&#x60;, &#x60;accounts_receivable_account&#x60;, &#x60;on_account_account&#x60;, &#x60;subscription_id&#x60;, &#x60;subscription_item_id&#x60;, &#x60;tax&#x60;, &#x60;tax_code&#x60;, &#x60;tax_inclusive&#x60;, &#x60;unit_amount&#x60;, &#x60;unit_of_measure&#x60;, &#x60;subtotal&#x60;, &#x60;invoice_item_id&#x60;, &#x60;document_item_date&#x60;          &lt;/details&gt;</param>
        ...
        /// <response code="504">Gateway Timeout</response>
        [HttpPost]
        [Route("/v2/credit_memos/{credit_memo_id}/post")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("PostCreditMemo")]
        [SwaggerResponse(statusCode: 200, type: typeof(CreditMemo), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult PostCreditMemo([FromRoute][Required]string creditMemoId, [FromQuery]List<string> fields, [FromQuery]List<string> appliedToFields, [FromQuery]List<string> creditMemoItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> accountFields, [FromQuery]List<string> billToFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityId, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(CreditMemo));
        ...
        /// </summary>
        /// <remarks>Unapply an applied credit memo.</remarks>
        /// <param name="body"></param>
        /// <param name="creditMemoId">Identifier for the credit memo, either &#x60;credit_memo_number&#x60; or &#x60;credit_memo_id&#x60;</param>
        /// <param name="zuoraTrackId">A custom identifier for tracking API requests. If you set a value for this header, Zuora returns the same value in the response header. This header enables you to track your API calls to assist with troubleshooting in the event of an issue. The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (:), semicolon (;), double quote (\&quot;), or quote (&#x27;).</param>
        /// <param name="_async">Making asynchronous requests allows you to scale your applications more efficiently by leveraging Zuora&#x27;s infrastructure to enqueue and execute requests for you without blocking. These requests also use built-in retry semantics, which makes them much less likely to fail for non-deterministic reasons, even in extreme high-throughput scenarios. Meanwhile, when you send a request to one of these endpoints, you can expect to receive a response in less than 150 milliseconds and these calls are unlikely to trigger rate limit errors. If set to true, Zuora returns a 202 Accepted response, and the response body contains only a request ID.</param>
        ...
        /// <response code="504">Gateway Timeout</response>
        [HttpPost]
        [Route("/v2/credit_memos/{credit_memo_id}/unapply")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("UnapplyCreditMemo")]
        [SwaggerResponse(statusCode: 200, type: typeof(CreditMemo), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult UnapplyCreditMemo([FromBody]ApplyUnapplyCreditMemo body, [FromRoute][Required]string creditMemoId, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding, [FromQuery]List<string> fields, [FromQuery]List<string> appliedToFields, [FromQuery]List<string> creditMemoItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> accountFields, [FromQuery]List<string> billToFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(CreditMemo));
        ...
        /// </summary>
        /// <remarks>Unposts an open credit memo that has not been applied, and changes its &#x60;state&#x60; to &#x60;draft&#x60;.</remarks>
        /// <param name="creditMemoId">Identifier for the credit memo, either &#x60;credit_memo_number&#x60; or &#x60;credit_memo_id&#x60;</param>
        /// <param name="fields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;credit_memo_number&#x60;, &#x60;state_transitions&#x60;, &#x60;description&#x60;, &#x60;account_id&#x60;, &#x60;total&#x60;, &#x60;subtotal&#x60;, &#x60;tax&#x60;, &#x60;document_date&#x60;, &#x60;exclude_from_auto_apply_rules&#x60;, &#x60;posted_by_id&#x60;, &#x60;state&#x60;, &#x60;balance&#x60;, &#x60;invoice_id&#x60;, &#x60;reason_code&#x60;, &#x60;amount_refunded&#x60;, &#x60;bill_to_id&#x60;, &#x60;billing_document_settings&#x60;, &#x60;currency&#x60;          &lt;/details&gt;</param>
        /// <param name="appliedToFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;id&#x60;, &#x60;amount&#x60;, &#x60;billing_document_id&#x60;, &#x60;billing_document_type&#x60;          &lt;/details&gt;</param>
        /// <param name="creditMemoItemsFields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;amount&#x60;, &#x60;applied_to_item_id&#x60;, &#x60;price_id&#x60;, &#x60;discount_item&#x60;, &#x60;deferred_revenue_account&#x60;, &#x60;description&#x60;, &#x60;credit_memo_id&#x60;, &#x60;sku&#x60;, &#x60;name&#x60;, &#x60;purchase_order_number&#x60;, &#x60;quantity&#x60;, &#x60;recognized_revenue_account&#x60;, &#x60;remaining_balance&#x60;, &#x60;revenue_recognition_rule_name&#x60;, &#x60;service_end&#x60;, &#x60;service_start&#x60;, &#x60;accounts_receivable_account&#x60;, &#x60;on_account_account&#x60;, &#x60;subscription_id&#x60;, &#x60;subscription_item_id&#x60;, &#x60;tax&#x60;, &#x60;tax_code&#x60;, &#x60;tax_inclusive&#x60;, &#x60;unit_amount&#x60;, &#x60;unit_of_measure&#x60;, &#x60;subtotal&#x60;, &#x60;invoice_item_id&#x60;, &#x60;document_item_date&#x60;          &lt;/details&gt;</param>
        ...
        /// <response code="504">Gateway Timeout</response>
        [HttpPost]
        [Route("/v2/credit_memos/{credit_memo_id}/unpost")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("UnpostCreditMemo")]
        [SwaggerResponse(statusCode: 200, type: typeof(CreditMemo), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult UnpostCreditMemo([FromRoute][Required]string creditMemoId, [FromQuery]List<string> fields, [FromQuery]List<string> appliedToFields, [FromQuery]List<string> creditMemoItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> accountFields, [FromQuery]List<string> billToFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityId, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(CreditMemo));
