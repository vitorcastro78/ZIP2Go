...
{ 
    ...
    /// </summary>
    [ApiController]
    public class BillingDocumentsApiController : ControllerBase
    { 
        /// <summary>
        /// Retrieve a billing document
        /// </summary>
        /// <remarks>Retrieves the billing document with the given ID.</remarks>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(BillingDocument), description: "Default Response")]
        ...
        public virtual IActionResult GetBillingDocument([FromRoute][Required]string billingDocumentId, [FromQuery]List<string> fields, [FromQuery]List<string> billingDocumentItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize, [FromHeader]string zuoraTrackId, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(BillingDocument));
        ...
        /// </summary>
        /// <remarks>Returns a dictionary with a data property that contains an array of billing documents, starting after cursor. Each entry in the array is a separate billing document object. If no more billing documents are available, the resulting array will be empty. This request should never return an error.</remarks>
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(BillingDocumentListResponse), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult GetBillingDocuments([FromQuery]string cursor, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery]List<string> sort, [FromQuery][Range(1, 99)]int? pageSize, [FromQuery]List<string> fields, [FromQuery]List<string> billingDocumentItemsFields, [FromQuery]List<string> taxationItemsFields, [FromHeader]string zuoraTrackId, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(BillingDocumentListResponse));
            ...
            exampleJson = "{\n  \"next_page\" : \"next_page\",\n  \"data\" : [ {\n    \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"account_number\" : \"account_number\",\n    \"amount_paid\" : 7.061401241503109,\n    \"exclude_from_auto_apply_rules\" : true,\n    \"description\" : \"description\",\n    \"state_transitions\" : \"\",\n    \"past_due\" : true,\n    \"type\" : \"credit_memo\",\n    \"amount_refunded\" : 0.8008281904610115,\n    \"reason_code\" : \"reason_code\",\n    \"total\" : 6.027456183070403,\n    \"billing_document_number\" : \"billing_document_number\",\n    \"balance\" : 5.637376656633329,\n    \"invoice_id\" : \"invoice_id\",\n    \"id\" : \"id\",\n    \"state\" : \"draft\",\n    \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"transfer_to_accounting\" : true,\n    \"posted_by_id\" : \"posted_by_id\",\n    \"remaining_balance\" : 2.3021358869347655,\n    \"custom_fields\" : \"\",\n    \"due_date\" : \"2023-01-01T00:00:00.000+00:00\",\n    \"document_date\" : \"2023-01-01T00:00:00.000+00:00\",\n    \"pay\" : true,\n    \"tax\" : 5.962133916683182,\n    \"account_id\" : \"account_id\",\n    \"custom_objects\" : \"\",\n    \"subtotal\" : 1.4658129805029452,\n    \"paid\" : true,\n    \"updated_by_id\" : \"updated_by_id\",\n    \"created_by_id\" : \"created_by_id\",\n    \"items\" : \"\",\n    \"account\" : \"\"\n  }, {\n    \"updated_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"account_number\" : \"account_number\",\n    \"amount_paid\" : 7.061401241503109,\n    \"exclude_from_auto_apply_rules\" : true,\n    \"description\" : \"description\",\n    \"state_transitions\" : \"\",\n    \"past_due\" : true,\n    \"type\" : \"credit_memo\",\n    \"amount_refunded\" : 0.8008281904610115,\n    \"reason_code\" : \"reason_code\",\n    \"total\" : 6.027456183070403,\n    \"billing_document_number\" : \"billing_document_number\",\n    \"balance\" : 5.637376656633329,\n    \"invoice_id\" : \"invoice_id\",\n    \"id\" : \"id\",\n    \"state\" : \"draft\",\n    \"created_time\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"transfer_to_accounting\" : true,\n    \"posted_by_id\" : \"posted_by_id\",\n    \"remaining_balance\" : 2.3021358869347655,\n    \"custom_fields\" : \"\",\n    \"due_date\" : \"2023-01-01T00:00:00.000+00:00\",\n    \"document_date\" : \"2023-01-01T00:00:00.000+00:00\",\n    \"pay\" : true,\n    \"tax\" : 5.962133916683182,\n    \"account_id\" : \"account_id\",\n    \"custom_objects\" : \"\",\n    \"subtotal\" : 1.4658129805029452,\n    \"paid\" : true,\n    \"updated_by_id\" : \"updated_by_id\",\n    \"created_by_id\" : \"created_by_id\",\n    \"items\" : \"\",\n    \"account\" : \"\"\n  } ]\n}";
                        ...
                        var example = exampleJson != null
                        ? JsonConvert.DeserializeObject<BillingDocumentListResponse>(exampleJson)
                        : default(BillingDocumentListResponse);            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        /// </summary>
        /// <remarks>Creates different types of billing document objects, including invoices, credit memos, and debit memos.</remarks>
        ...
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("PostBillingDocument")]
        [SwaggerResponse(statusCode: 201, type: typeof(BillingDocument), description: "Default Response")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthorized")]
        [SwaggerResponse(statusCode: 404, type: typeof(ErrorResponse), description: "Not Found")]
        [SwaggerResponse(statusCode: 405, type: typeof(ErrorResponse), description: "Method Not Allowed")]
        ...
        [SwaggerResponse(statusCode: 503, type: typeof(ErrorResponse), description: "Service Unavailable")]
        [SwaggerResponse(statusCode: 504, type: typeof(ErrorResponse), description: "Gateway Timeout")]
        public virtual IActionResult PostBillingDocument([FromBody]BillingDocumentCreateRequest body, [FromHeader]string zuoraTrackId, [FromHeader]bool? _async, [FromHeader]string zuoraEntityIds, [FromHeader]string idempotencyKey, [FromHeader]string acceptEncoding, [FromHeader]string contentEncoding, [FromQuery]List<string> fields, [FromQuery]List<string> billingDocumentItemsFields, [FromQuery]List<string> taxationItemsFields, [FromQuery]List<string> expand, [FromQuery]List<string> filter, [FromQuery][Range(1, 99)]int? pageSize)
        { 
