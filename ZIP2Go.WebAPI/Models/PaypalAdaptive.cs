...
namespace ZIP2Go.WebAPI.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaypalAdaptive : IEquatable<PaypalAdaptive>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PaypalAdaptive)obj);
        }

        /// <summary>
        /// Returns true if PaypalAdaptive instances are equal
        /// </summary>
        /// <param name="other">Instance of PaypalAdaptive to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaypalAdaptive other)
        {
            ...
            return 
                (
                    PreapprovalKey == other.PreapprovalKey ||
                    PreapprovalKey != null &&
                    PreapprovalKey.Equals(other.PreapprovalKey)
                ) && 
                (
                    Email == other.Email ||
                    Email != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + PreapprovalKey.GetHashCode();
                    if (Email != null)
        ...
        public static bool operator ==(PaypalAdaptive left, PaypalAdaptive right)
        {
