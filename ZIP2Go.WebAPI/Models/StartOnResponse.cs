...
namespace ZIP2Go.WebAPI.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class StartOnResponse : IEquatable<StartOnResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((StartOnResponse)obj);
        }

        /// <summary>
        /// Returns true if StartOnResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of StartOnResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StartOnResponse other)
        {
        ...
        public static bool operator ==(StartOnResponse left, StartOnResponse right)
        {
