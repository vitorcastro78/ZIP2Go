...
namespace ZIP2Go.WebAPI.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GooglePay : IEquatable<GooglePay>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GooglePay)obj);
        }

        /// <summary>
        /// Returns true if GooglePay instances are equal
        /// </summary>
        /// <param name="other">Instance of GooglePay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GooglePay other)
        {
        ...
        public static bool operator ==(GooglePay left, GooglePay right)
        {
