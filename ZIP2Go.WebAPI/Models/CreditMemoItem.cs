...
namespace ZIP2Go.WebAPI.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditMemoItem : IEquatable<CreditMemoItem>
    { 
        /// <summary>
        ...
        public OneOfcreditMemoItemCustomObjects CustomObjects { get; private set; }
        ...
        public AllOfcreditMemoItemSubscription Subscription { get; private set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CreditMemoItem)obj);
        }

        /// <summary>
        /// Returns true if CreditMemoItem instances are equal
        /// </summary>
        /// <param name="other">Instance of CreditMemoItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditMemoItem other)
        {
            ...
            return 
                ...
                (
                    CreditMemoId == other.CreditMemoId ||
                    CreditMemoId != null &&
                    CreditMemoId.Equals(other.CreditMemoId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CreditMemoId.GetHashCode();
        ...
        public static bool operator ==(CreditMemoItem left, CreditMemoItem right)
        {
