...
namespace ZIP2Go.WebAPI.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RunWorkflowRequest : IEquatable<RunWorkflowRequest>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RunWorkflowRequest)obj);
        }

        /// <summary>
        /// Returns true if RunWorkflowRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of RunWorkflowRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RunWorkflowRequest other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + InputParameters.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(RunWorkflowRequest left, RunWorkflowRequest right)
        {
