...
namespace ZIP2Go.WebAPI.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayDebitMemoRequest : IEquatable<PayDebitMemoRequest>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PayDebitMemoRequest)obj);
        }

        /// <summary>
        /// Returns true if PayDebitMemoRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of PayDebitMemoRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayDebitMemoRequest other)
        {
        ...
        public static bool operator ==(PayDebitMemoRequest left, PayDebitMemoRequest right)
        {
