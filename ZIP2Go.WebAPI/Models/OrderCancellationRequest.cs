...
namespace ZIP2Go.WebAPI.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderCancellationRequest : IEquatable<OrderCancellationRequest>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OrderCancellationRequest)obj);
        }

        /// <summary>
        /// Returns true if OrderCancellationRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of OrderCancellationRequest to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(OrderCancellationRequest left, OrderCancellationRequest right)
        {
