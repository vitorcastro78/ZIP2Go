...
namespace ZIP2GO.WebAPI.Controllers
{
    ...
    public class PricesController : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>This method supports partial updates to a price resource. Only the fields specified in the request
        /// body will be updated. The method requires the caller to be authenticated and authorized.</remarks>
        /// <param name="body">The request body containing the fields to update and their new values.</param>
        /// <param name="priceId">The unique identifier of the price resource to update. This parameter is required.</param>
        /// <param name="zuoraTrackId">An optional tracking identifier for the request, used for correlation purposes in external systems.</param>
        /// <param name="async">A boolean value indicating whether the operation should be performed asynchronously.  <see langword="true"/> to
        /// perform the operation asynchronously; otherwise, <see langword="false"/>.</param>
        /// <returns>An <see cref="IActionResult"/> containing the updated <see cref="Price"/> resource if the operation is successful.
        /// If the operation fails, an appropriate error response is returned.</returns>
        [HttpPatch]
        [Route("/prices/{price_id}")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
