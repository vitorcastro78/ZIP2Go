...
namespace ZIP2GO.WebAPI.Controllers
{
    ...
    public class SubscriptionItemsController : ControllerBaseApi
    {
        ...
        /// </summary>
        /// <remarks>List items contained in subscriptions.</remarks>
        ...
        [HttpGet]
        [Route("/v2/subscription_items")]
        [Authorize(AuthenticationSchemes = BearerAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("GetSubscriptionItems")]
        [SwaggerResponse(statusCode: 200, type: typeof(SubscriptionItemListResponse), description: "Default Response")]
