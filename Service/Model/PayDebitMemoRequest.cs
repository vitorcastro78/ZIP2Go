...
namespace ZIP2Go.Model {
  ...
  /// </summary>
  [DataContract]
  public class PayDebitMemoRequest {
    /// <summary>
    ...
    /// </summary>
    /// <value>3-letter ISO 4217 currency code. This field is available only if you have the [Multiple Currencies](https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Flexible_Billing/Multiple_Currencies) feature enabled and are creating a debit memo from a charge.</value>
