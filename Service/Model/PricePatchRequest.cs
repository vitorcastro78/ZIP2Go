...
namespace ZIP2Go.Model {
  ...
  public class PricePatchRequest {
    ...
    public OneOfpricePatchRequestCustomObjects CustomObjects { get; set; }
    ...
    public AllOfpricePatchRequestOverage Overage { get; set; }
    ...
    public AllOfpricePatchRequestRevenue Revenue { get; set; }
