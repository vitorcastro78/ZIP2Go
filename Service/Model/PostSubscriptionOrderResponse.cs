...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PostSubscriptionOrderResponse {
    /// <summary>
    ...
    public OneOfpostSubscriptionOrderResponseCustomObjects CustomObjects { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseAccount Account { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseInvoiceOwnerAccount InvoiceOwnerAccount { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseInitialTerm InitialTerm { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseCurrentTerm CurrentTerm { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseRenewalTerm RenewalTerm { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseSubscriptionPlans SubscriptionPlans { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseInvoiceItems InvoiceItems { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseBillTo BillTo { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseBillingDocumentSettings BillingDocumentSettings { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseSoldTo SoldTo { get; set; }
    ...
    public AllOfpostSubscriptionOrderResponseArTransactions ArTransactions { get; set; }
