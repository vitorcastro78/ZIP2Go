...
namespace ZIP2Go.Model {
  ...
  public class OrdersProcessingOption {
    ...
    [JsonProperty(PropertyName = "collection_method")]
    ...
    [JsonProperty(PropertyName = "draft_invoice")]
    public bool? DraftInvoice { get; set; }

    /// <summary>
    /// Gets or Sets RefundReasonCode
    /// </summary>
    [DataMember(Name="refund_reason_code", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "refund_reason_code")]
