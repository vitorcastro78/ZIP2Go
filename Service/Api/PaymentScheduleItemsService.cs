...
namespace Service
{
    ...
    public class PaymentScheduleItemsService : IPaymentScheduleItemsService
    {
        ...
        /// </summary>
        /// <param name="paymentScheduleItemId">Identifier for the payment schedule item. Can be either &#x60;paymentScheduleItemId&#x60; or &#x60;payment_schedule_item_number&#x60;</param>
        ...
        public PaymentScheduleItem CancelPaymentScheduleItem(string paymentScheduleItemId, string zuoraTrackId, bool? async)
        {
            ...
            var path =$"v2/payment_schedule_items/{paymentScheduleItemId}/cancel";
            
            path = path.Replace("{" + "paymentScheduleItemId" + "}", _apiClient.ParameterToString(paymentScheduleItemId));
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>PaymentScheduleItem</returns>
        public PaymentScheduleItem CreatePaymentScheduleItem(PaymentScheduleItemCreateRequest body, string zuoraTrackId, bool? async)
        {
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>PaymentScheduleItem</returns>
        public PaymentScheduleItem GetPaymentScheduleItem(string paymentScheduleItemId, string zuoraTrackId, bool? async)
        {
            // verify the required parameter 'paymentScheduleItemId' is set
            ...
            var path =$"v2/payment_schedule_items/{paymentScheduleItemId}";
            ...
            // make the HTTP request
            RestResponse response = (RestResponse)_apiClient.CallApi<PaymentScheduleItem>(path, Method.Get, queryParams, postBody);
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>PaymentScheduleItem</returns>
        public PaymentScheduleItem RetryPaymentScheduleItem(PaymentScheduleItemRetry body, string paymentScheduleItemId, string zuoraTrackId, bool? async)
        {
            // verify the required parameter 'body' is set
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling RetryPaymentScheduleItem");
            // verify the required parameter 'paymentScheduleItemId' is set
            ...
            var path =$"v2/payment_schedule_items/{paymentScheduleItemId}/retry";
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>PaymentScheduleItem</returns>
        public PaymentScheduleItem SkipPaymentScheduleItem(string paymentScheduleItemId, string zuoraTrackId, bool? async)
        {
            // verify the required parameter 'paymentScheduleItemId' is set
            ...
            var path =$"v2/payment_schedule_items/{paymentScheduleItemId}/skip";
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>PaymentScheduleItem</returns>
        public PaymentScheduleItem UpdatePaymentScheduleItem(PaymentScheduleItemPatch body, string paymentScheduleItemId, string zuoraTrackId, bool? async)
        {
            // verify the required parameter 'body' is set
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling UpdatePaymentScheduleItem");
            // verify the required parameter 'paymentScheduleItemId' is set
        ...
        public PaymentScheduleItem GetPaymentScheduleItemCached(string paymentScheduleItemId) => _apiClient.RequestCachedResult<PaymentScheduleItem>(paymentScheduleItemId);
    }
}