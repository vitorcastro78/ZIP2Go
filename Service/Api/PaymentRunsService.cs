...
namespace Service
{
    ...
    public class PaymentRunsService : IPaymentRunsService
    {
        ...
        public PaymentRunListResponse GetPaymentRunsCached()
        {
            return new PaymentRunListResponse
            {
                Data = _apiClient.RequestCachedResult<PaymentRun>()
            };
        }

        public PaymentRun GetPaymentRunCached(string paymentRunId) => _apiClient.RequestCachedResult<PaymentRun>(paymentRunId);
    }
}