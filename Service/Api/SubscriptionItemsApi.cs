...
namespace ZIP2Go.Service
{
    ...
    /// </summary>
    public interface ISubscriptionItemsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class SubscriptionItemsApi : ISubscriptionItemsApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public SubscriptionItemsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public SubscriptionItemsApi(String basePath)
        {
