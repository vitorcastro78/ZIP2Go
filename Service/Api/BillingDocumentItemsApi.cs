...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IBillingDocumentItemsApi
    {
        /// <summary>
        ...
        BillingDocumentItemListResponse GetBillingDocumentItems (string cursor, List<string> expand, List<string> filter, List<string> sort, int? pageSize, List<string> fields, List<string> taxationItemsFields, string zuoraTrackId, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding);
    }
  
    /// <summary>
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class BillingDocumentItemsApi : IBillingDocumentItemsApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public BillingDocumentItemsApi(ApiClient apiClient = null)
        {
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
            ...
            return (BillingDocumentItemListResponse) ApiClient.Deserialize(response.Content, typeof(BillingDocumentItemListResponse), response.Headers);
        }
