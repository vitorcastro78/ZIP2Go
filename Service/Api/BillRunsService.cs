...
namespace ZIP2GO.Service
{
    ...
    public class BillRunsService : IBillRunsService
    {
        ...
        /// <returns></returns>
        public BillRunsService(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public BillRunsService(string basePath)
        {
        ...
        public BillRun CancelBillRun(string billRunId, List<string> fields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId, bool? async, string zuoraEntityId, string idempotencyKey, string acceptEncoding, string contentEncoding)
        {
            ...
            return (BillRun)ApiClient.Deserialize(response.Content, typeof(BillRun));
        }
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>BillRun</returns>
        public BillRun CreateBillRun(BillRunCreateRequest body, string zuoraTrackId, bool? async, List<string> fields, List<string> expand, List<string> filter, int? pageSize)
        {
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>BillRun</returns>
        public BillRun GetBillRun(string billRunId, List<string> fields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId)
        {
            // verify the required parameter 'billRunId' is set
        ...
        public BillRunListResponse GetBillRuns(string cursor, List<string> expand, List<string> filter, List<string> sort, int? pageSize, List<string> fields, string zuoraTrackId)
        {
            var path = "/bill_runs";
            path = path.Replace("{format}", "json");
            ...
            return (BillRunListResponse)ApiClient.Deserialize(response.Content, typeof(BillRunListResponse));
        }
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>BillRun</returns>
        public BillRun PostBillRun(BillRunPostRequest body, string billRunId, string zuoraTrackId, bool? async, List<string> fields, List<string> expand, List<string> filter, int? pageSize)
        {
            // verify the required parameter 'body' is set
