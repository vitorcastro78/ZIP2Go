...
namespace ZIP2GO.Service
{
    ...
    public class BillingDocumentsService : IBillingDocumentsService
    {
        ...
        /// <param name="fields">Allows you to specify which fields are returned in the response.          &lt;details&gt;            &lt;summary&gt; Accepted values &lt;/summary&gt;              &#x60;custom_fields&#x60;, &#x60;created_by_id&#x60;, &#x60;updated_by_id&#x60;, &#x60;created_time&#x60;, &#x60;id&#x60;, &#x60;updated_time&#x60;, &#x60;account_id&#x60;, &#x60;balance&#x60;, &#x60;description&#x60;, &#x60;state&#x60;, &#x60;tax&#x60;          &lt;/details&gt;</param>
        ...
        public BillingDocument GetBillingDocument(string billingDocumentId, List<string> fields, List<string> billingDocumentItemsFields, List<string> taxationItemsFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId)
        {
        ...
        public BillingDocumentListResponse GetBillingDocuments(string cursor, List<string> expand, List<string> filter, List<string> sort, int? pageSize, List<string> fields, List<string> billingDocumentItemsFields, List<string> taxationItemsFields, string zuoraTrackId)
        {
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>BillingDocument</returns>
        public BillingDocument PostBillingDocument(BillingDocumentCreateRequest body, string zuoraTrackId, bool? async, List<string> fields, List<string> billingDocumentItemsFields, List<string> taxationItemsFields, List<string> expand, List<string> filter, int? pageSize)
        {
