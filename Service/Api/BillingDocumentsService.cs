...
namespace Service
{
    ...
    public class BillingDocumentsService : IBillingDocumentsService
    {
        ...
        public BillingDocument GetBillingDocument(string billingDocumentId, List<string> fields, List<string> billingDocumentItemsFields, List<string> taxationItemsFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId, bool? async)
        {
