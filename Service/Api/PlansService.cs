...
namespace Service
{
    ...
    public class PlansService : IPlansService
    {
        ...
        /// <returns></returns>
        public PlansService(ApiClient apiClient, IEasyCachingProvider cache)
        {
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>Plan</returns>
        public Plan GetPlan(string planId, List<string> fields, List<string> pricesFields, List<string> productFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId, bool? async)
        {
            // verify the required parameter 'planId' is set
