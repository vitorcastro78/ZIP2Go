...
namespace ZIP2GO.Service
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlansService"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public PlansService(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public PlansService(string basePath)
        {
        ...
        public Plan CreatePlan(PlanCreateRequest body, string zuoraTrackId, bool? async, List<string> fields, List<string> pricesFields, List<string> productFields, List<string> expand, List<string> filter, int? pageSize)
        {
            ...
            return (Plan)ApiClient.Deserialize(response.Content, typeof(Plan));
        }
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>Plan</returns>
        public Plan GetPlan(string planId, List<string> fields, List<string> pricesFields, List<string> productFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId)
        {
            // verify the required parameter 'planId' is set
        ...
        public PlanListResponse GetPlans(string cursor, List<string> expand, List<string> filter, List<string> sort, int? pageSize, List<string> fields, List<string> pricesFields, List<string> productFields, string zuoraTrackId)
        {
            var path = "/plans";
            path = path.Replace("{format}", "json");
            ...
            return (PlanListResponse)ApiClient.Deserialize(response.Content, typeof(PlanListResponse));
        }
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>Plan</returns>
        public Plan UpdatePlan(PlanPatchRequest body, string planId, string zuoraTrackId, bool? async, List<string> fields, List<string> pricesFields, List<string> productFields, List<string> expand, List<string> filter, int? pageSize)
        {
            // verify the required parameter 'body' is set
