...
namespace Service
{
    ...
    public class TaxationItemsService : ITaxationItemsService
    {
        ...
        /// <returns></returns>
        public TaxationItemsService(ApiClient apiClient)
        {
        ...
        public TaxationItem CreateTaxationItem(TaxationItemCreateRequest body, string zuoraTrackId, bool? async)
        {
            ...
            return (TaxationItem)_apiClient.Deserialize(response.Content, typeof(TaxationItem));
        }
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns></returns>
        public void DeleteTaxationItem(string taxationItemId, string zuoraTrackId, bool? async)
        {
            ...
            // make the HTTP request
            RestResponse response = (RestResponse)_apiClient.CallApi<TaxationItem>(path, Method.Delete, queryParams, postBody);
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>TaxationItem</returns>
        public TaxationItem GetTaxationItem(string taxationItemId, string zuoraTrackId, bool? async)
        {
            // verify the required parameter 'taxationItemId' is set
            ...
            // make the HTTP request
            RestResponse response = (RestResponse)_apiClient.CallApi<TaxationItem>(path, Method.Get, queryParams, postBody);
        ...
        public TaxationItemListResponse GetTaxationItems(string zuoraTrackId, bool? async)
        {
            ...
            // make the HTTP request
            RestResponse response = (RestResponse)_apiClient.CallApi<TaxationItemListResponse>(path, Method.Get, queryParams, postBody);
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>TaxationItem</returns>
        public TaxationItem UpdateTaxationItem(TaxationItemPatchRequest body, string taxationItemId, string zuoraTrackId, bool? async)
        {
            // verify the required parameter 'body' is set
        ...
        public TaxationItemListResponse GetTaxationItemsCached()
        {
            return new TaxationItemListResponse
            {
                Data = _apiClient.RequestCachedResult<TaxationItem>()
            };
        }

        public TaxationItem GetTaxationItemCached(string taxationItemId) => _apiClient.RequestCachedResult<TaxationItem>(taxationItemId);
    }
}