...
namespace ZIP2Go.Api
{
    ...
    /// </summary>
    public interface IFulfillmentItemsApi
    {
        /// <summary>
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>FulfillmentItem</returns>
        FulfillmentItem UpdateFulfillmentItem (FulfillmentItemPatchRequest body, string fulfillmentItemId, string zuoraTrackId, bool? async, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding, List<string> fields, List<string> expand, List<string> filter, int? pageSize);
    }
  
    /// <summary>
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class FulfillmentItemsApi : IFulfillmentItemsApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public FulfillmentItemsApi(ApiClient apiClient = null)
        {
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>FulfillmentItem</returns>
        public FulfillmentItem CreateFulfillmentItem (FulfillmentItemCreateRequest body, string zuoraTrackId, bool? async, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding, List<string> fields, List<string> expand, List<string> filter, int? pageSize)
        {
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
            ...
            if (((int)response.StatusCode) >= 400)
                ...
                throw new ApiException ((int)response.StatusCode, "Error calling CreateFulfillmentItem: " + response.ErrorMessage, response.ErrorMessage);
    
            return (FulfillmentItem) ApiClient.Deserialize(response.Content, typeof(FulfillmentItem), response.Headers);
        }
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>FulfillmentItemCreateBulkResponse</returns>
        public FulfillmentItemCreateBulkResponse CreateFulfillmentItems (FulfillmentItemCreateBulkRequest body, string zuoraTrackId, bool? async, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding, List<string> fields, List<string> expand, List<string> filter, int? pageSize)
        {
            // verify the required parameter 'body' is set
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
            ...
            if (((int)response.StatusCode) >= 400)
                ...
                throw new ApiException ((int)response.StatusCode, "Error calling CreateFulfillmentItems: " + response.ErrorMessage, response.ErrorMessage);
    
            return (FulfillmentItemCreateBulkResponse) ApiClient.Deserialize(response.Content, typeof(FulfillmentItemCreateBulkResponse), response.Headers);
        }
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns></returns>
        public void DeleteFulfillmentItem (string fulfillmentItemId, string zuoraTrackId, bool? async, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding)
        {
            ...
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "fulfillment_item_id" + "}", ApiClient.ParameterToString(fulfillmentItemId));
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling DeleteFulfillmentItem: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling DeleteFulfillmentItem: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>FulfillmentItem</returns>
        public FulfillmentItem GetFulfillmentItem (string fulfillmentItemId, List<string> fields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding)
        {
            // verify the required parameter 'fulfillmentItemId' is set
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetFulfillmentItem: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetFulfillmentItem: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>FilfillmentItemListResponse</returns>
        public FilfillmentItemListResponse GetFulfillmentItems (string cursor, List<string> expand, List<string> filter, List<string> sort, int? pageSize, List<string> fields, string zuoraTrackId, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding)
        {
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetFulfillmentItems: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetFulfillmentItems: " + response.ErrorMessage, response.ErrorMessage);
    
            return (FilfillmentItemListResponse) ApiClient.Deserialize(response.Content, typeof(FilfillmentItemListResponse), response.Headers);
        }
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>FulfillmentItem</returns>
        public FulfillmentItem UpdateFulfillmentItem (FulfillmentItemPatchRequest body, string fulfillmentItemId, string zuoraTrackId, bool? async, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding, List<string> fields, List<string> expand, List<string> filter, int? pageSize)
        {
            // verify the required parameter 'body' is set
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling UpdateFulfillmentItem");
            // verify the required parameter 'fulfillmentItemId' is set
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
            ...
            if (((int)response.StatusCode) >= 400)
                ...
                throw new ApiException ((int)response.StatusCode, "Error calling UpdateFulfillmentItem: " + response.ErrorMessage, response.ErrorMessage);
