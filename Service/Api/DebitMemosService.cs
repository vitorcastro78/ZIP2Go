...
namespace Service
{
    ...
    public class DebitMemosService : IDebitMemosService
    {
        ...
        /// <returns></returns>
        public DebitMemosService(ApiClient apiClient, IEasyCachingProvider cache)
        {
        ...
        public DebitMemoItemListResponse GetDebitMemoItems(string cursor, string zuoraTrackId, bool? async)
        {
            ...
            return (DebitMemoItemListResponse)_apiClient.Deserialize(response.Content, typeof(DebitMemoItemListResponse));
        }
        ...
        public DebitMemoListResponse GetDebitMemos(string cursor, string zuoraTrackId, bool? async)
        {
            ...
            return (DebitMemoListResponse)_apiClient.Deserialize(response.Content, typeof(DebitMemoListResponse));
        }
