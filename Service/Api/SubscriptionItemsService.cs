...
namespace Service
{
    ...
    public class SubscriptionItemsService : ISubscriptionItemsService
    {
        ...
        public SubscriptionItemListResponse GetSubscriptionItemsCached()
        {
            return new SubscriptionItemListResponse
            {
                Data = _apiClient.RequestCachedResult<SubscriptionItem>()
            };
        }
    }
}