...
namespace ZIP2GO.Service
{
    ...
    public class OrderLineItemsService : IOrderLineItemsService
    {
        ...
        public OrderLineItem GetOrderLineItem(string orderLineItemId, List<string> fields, List<string> lineItemFields, List<string> invoiceItemsFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId)
        {
