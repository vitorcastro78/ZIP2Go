...
namespace ZIP2GO.Service
{
    ...
    public class OrderLineItemsService : IOrderLineItemsService
    {
        ...
        public OrderLineItem GetOrderLineItem(string orderLineItemId, List<string> fields, List<string> lineItemFields, List<string> invoiceItemsFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId, bool? async)
        {
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>OrderLineItem</returns>
        public OrderLineItem PatchOrderLineItem(LineItemPatchRequest body, string orderLineItemId, string zuoraTrackId, bool? async, List<string> fields, List<string> lineItemFields, List<string> invoiceItemsFields, List<string> expand, List<string> filter, int? pageSize)
        {
