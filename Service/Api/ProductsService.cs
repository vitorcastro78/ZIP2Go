...
namespace ZIP2GO.Service
{
    ...
    public class ProductsService : IProductsService
    {
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>Product</returns>
        public Product GetProduct(string productId, List<string> fields, List<string> plansFields, List<string> pricesFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId)
        {
            // verify the required parameter 'productId' is set
        ...
        public ProductListResponse GetProducts(string cursor, List<string> expand, List<string> filter, List<string> sort, int? pageSize, List<string> fields, List<string> plansFields, List<string> pricesFields, string zuoraTrackId)
        {
            var path = "/products";
            path = path.Replace("{format}", "json");
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>Product</returns>
        public Product UpdateProduct(ProductPatchRequest body, string productId, string zuoraTrackId, bool? async, List<string> fields, List<string> plansFields, List<string> pricesFields, List<string> expand, List<string> filter, int? pageSize)
        {
            // verify the required parameter 'body' is set
