...
namespace Service
{
    ...
    public class QueryRunsService : IQueryRunsService
    {
        ...
        /// <returns></returns>
        public QueryRunsService(ApiClient apiClient)
        {
        ...
        /// </summary>
        /// <param name="queryRunId">queryRunId</param>
        ...
        public QueryRun CancelQueryRun(string queryRunId, string zuoraTrackId, bool? async)
        {
            ...
            var path =$"v2/query_runs/{queryRunId}/cancel";
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>QueryRun</returns>
        public QueryRun CreateQueryRun(QueryRunCreateRequest body, string zuoraTrackId, bool? async)
        {
        ...
        public QueryRun GetQueryRun(string queryRunId, string zuoraTrackId, bool? async)
        {
            ...
            // make the HTTP request
            RestResponse response = (RestResponse)_apiClient.CallApi<QueryRun>(path, Method.Get, queryParams, postBody);
        ...
        public QueryRun GetQueryRunCached(string queryRunId) => _apiClient.RequestCachedResult<QueryRun>(queryRunId);
    }
}