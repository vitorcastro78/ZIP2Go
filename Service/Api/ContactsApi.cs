...
namespace IO.Swagger.Api
{
    ...
    public interface IContactsApi
    {
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>Contact</returns>
        Contact UpdateContact (ContactPatchRequest body, string contactId, string zuoraTrackId, bool? async, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding, List<string> fields, List<string> expand, List<string> filter, int? pageSize);
    }
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
            ...
            return (ListContactResponse) ApiClient.Deserialize(response.Content, typeof(ListContactResponse), response.Headers);
        }
