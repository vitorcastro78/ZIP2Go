...
namespace ZIP2Go.Api
{
    ...
    /// </summary>
    public interface IBillRunPreviewsApi
    {
        /// <summary>
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>BillRunPreview</returns>
        BillRunPreview GetBillRunPreview (string billRunPreviewId, List<string> fields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding);
    }
  
    /// <summary>
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class BillRunPreviewsApi : IBillRunPreviewsApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public BillRunPreviewsApi(ApiClient apiClient = null)
        {
        ...
        /// <param name="pageSize">The maximum number of results to return in a single page. If the specified &#x60;page_size&#x60; is less than 1 or greater than 99, Zuora will return a 400 error.</param>
        /// <returns>BillRunPreview</returns>
        public BillRunPreview CreateBillRunPreview (BillRunPreviewCreateRequest body, string zuoraTrackId, bool? async, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding, List<string> fields, List<string> expand, List<string> filter, int? pageSize)
        {
 ...
 if (contentEncoding != null) headerParams.Add("content-encoding", ApiClient.ParameterToString(contentEncoding)); // header parameter
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>BillRunPreview</returns>
        public BillRunPreview GetBillRunPreview (string billRunPreviewId, List<string> fields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding)
        {
            ...
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "bill_run_preview_id" + "}", ApiClient.ParameterToString(billRunPreviewId));
