...
namespace ZIP2GO.Service
{
    ...
    public class FulfillmentService : IFulfillmentsService
    {
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>Fulfillment</returns>
        public Fulfillment GetFulfillment(string fulfillmentId, List<string> fields, List<string> fulfillmentItemFields, List<string> creditMemoItemFields, List<string> invoiceItemFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId)
        {
            // verify the required parameter 'fulfillmentId' is set
        ...
        public FilfillmentListResponse GetFulfillments(string cursor, List<string> expand, List<string> filter, List<string> sort, int? pageSize, List<string> fields, List<string> fulfillmentItemFields, List<string> creditMemoItemFields, List<string> invoiceItemFields, string zuoraTrackId)
        {
            var path = "/fulfillments";
            path = path.Replace("{format}", "json");
