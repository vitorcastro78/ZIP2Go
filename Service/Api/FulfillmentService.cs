...
namespace Service
{
    ...
    public class FulfillmentService : IFulfillmentsService
    {
        ...
        public FulfillmentListResponse GetFulfillmentsCached()
        {
            return new FulfillmentListResponse
            {
                Data = _apiClient.RequestCachedResult<Fulfillment>()
            };
        }

        public Fulfillment GetFulfillmentCached(string fulfillmentId) => _apiClient.RequestCachedResult<Fulfillment>(fulfillmentId);
    }
}