...
namespace Service
{
    ...
    public class RefundsService : IRefundsService
    {
        ...
        public RefundListResponse GetRefunds(string cursor, string zuoraTrackId, bool? async)
        {
            var path =$"v2/refunds";
        ...
        public RefundListResponse GetRefundsCached()
        {
            return new RefundListResponse
            {
                Data = _apiClient.RequestCachedResult<Refund>()
            };
        }

        public Refund GetRefundCached(string refundId) => _apiClient.RequestCachedResult<Refund>(refundId);
    }
}