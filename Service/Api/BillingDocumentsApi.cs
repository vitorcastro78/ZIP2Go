...
namespace ZIP2Go.Api
{
    ...
    /// </summary>
    public interface IBillingDocumentsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class BillingDocumentsApi : IBillingDocumentsApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public BillingDocumentsApi(ApiClient apiClient = null)
        {
        ...
        /// <param name="contentEncoding">Include a &#x60;content-encoding: gzip&#x60; header to compress a request. Upload a gzipped file for the payload if you specify this header. For more information, see [Request and Response Compression](https://developer.zuora.com/api-references/quickstart-api/tag/Request-and-Response-Compression/).</param>
        /// <returns>BillingDocument</returns>
        public BillingDocument GetBillingDocument (string billingDocumentId, List<string> fields, List<string> billingDocumentItemsFields, List<string> taxationItemsFields, List<string> expand, List<string> filter, int? pageSize, string zuoraTrackId, string zuoraEntityIds, string idempotencyKey, string acceptEncoding, string contentEncoding)
        {
