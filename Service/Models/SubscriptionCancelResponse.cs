...
namespace ZIP2Go.Models {
  ...
  public class SubscriptionCancelResponse {
    ...
    public OneOfsubscriptionCancelResponseCustomObjects CustomObjects { get; set; }
    ...
    public AllOfsubscriptionCancelResponseAccount Account { get; set; }
    ...
    [JsonProperty(PropertyName = "invoice_owner_account")]
    public AllOfsubscriptionCancelResponseInvoiceOwnerAccount InvoiceOwnerAccount { get; set; }
    ...
    public AllOfsubscriptionCancelResponseInitialTerm InitialTerm { get; set; }
    ...
    public AllOfsubscriptionCancelResponseCurrentTerm CurrentTerm { get; set; }
    ...
    public AllOfsubscriptionCancelResponseRenewalTerm RenewalTerm { get; set; }
    ...
    [JsonProperty(PropertyName = "contract_effective")]
    ...
    [JsonProperty(PropertyName = "service_activation")]
    ...
    [JsonProperty(PropertyName = "customer_acceptance")]
    ...
    public AllOfsubscriptionCancelResponseSubscriptionPlans SubscriptionPlans { get; set; }
    ...
    public AllOfsubscriptionCancelResponseInvoiceItems InvoiceItems { get; set; }
    ...
    [JsonProperty(PropertyName = "prepaid_balance")]
    ...
    [DataMember(Name="prepaid_balances", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "prepaid_balances")]
    ...
    [JsonProperty(PropertyName = "contracted_mrr")]
    ...
    [DataMember(Name="last_booking_date", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "last_booking_date")]
    ...
    public AllOfsubscriptionCancelResponseBillTo BillTo { get; set; }
    ...
    public AllOfsubscriptionCancelResponseBillingDocumentSettings BillingDocumentSettings { get; set; }
    ...
    public AllOfsubscriptionCancelResponseSoldTo SoldTo { get; set; }

    /// <summary>
    /// Gets or Sets ArTransactions
    /// </summary>
    [DataMember(Name="ar_transactions", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "ar_transactions")]
    public AllOfsubscriptionCancelResponseArTransactions ArTransactions { get; set; }

    /// <summary>
    /// The billing documents that are written off.
    /// </summary>
    /// <value>The billing documents that are written off.</value>
    [DataMember(Name="write_offs", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "write_offs")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class SubscriptionCancelResponse {\n");
