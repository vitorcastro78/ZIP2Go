...
namespace ZIP2GO.Service.Modelos
{
    ...
    /// </summary>
    [DataContract]
    public class AllOfsubscriptionCreateRequestInvoiceOwnerAccountData : AccountCreateRequest
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfsubscriptionCreateRequestInvoiceOwnerAccountData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    }
