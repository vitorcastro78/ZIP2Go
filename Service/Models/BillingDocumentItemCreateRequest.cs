...
namespace ZIP2Go.Models {
  ...
  public class BillingDocumentItemCreateRequest {
    ...
    /// </summary>
    /// <value>The end date of the service period associated with this billing document item. If the price for the associated subscription item is a one-time fee, then this date is the date of that subscription item.</value>
    ...
    /// </summary>
    /// <value>The start date of the service period associated with this billing document item. If the price for the associated subscription item is a one-time fee, then this date is the date of that subscription item.</value>
    ...
    /// </summary>
    /// <value>Indicates whether the billing document item amount is inclusive or exclusive of tax.</value>
