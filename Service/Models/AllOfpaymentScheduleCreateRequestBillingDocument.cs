...
namespace Zip2Go.Models
{
    ...
    /// </summary>
    [DataContract]
    public class AllOfpaymentScheduleCreateRequestBillingDocument : PaymentScheduleBillingDocumentRequest
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfpaymentScheduleCreateRequestBillingDocument {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    }
